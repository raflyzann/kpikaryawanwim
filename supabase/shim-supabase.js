...
(function () {
    ...
    // >>> WAJIB DIISI <<<
    const SUPABASE_URL = 'https://nwojyzeftbotqeqqldbs.supabase.co';
    const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im53b2p5emVmdGJvdHFlcXFsZGJzIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODk1OTI1NDAsImV4cCI6MjEwNTE2ODU0MH0.5TPe3O8VPLCcnr-c1-av2pIp1ipoaSEnybzUTx50H1k';
    ...
    /**
     * Unggah bukti piket: foto dikirim ke Edge Function `upload-piket` yang
     * menyimpan file ke Supabase Storage lalu mencatat barisnya lewat RPC.
     */
     ...
     *  - uploadPiket  -> Edge Function (karena mengirim foto)
